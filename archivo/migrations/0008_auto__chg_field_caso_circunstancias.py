...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caso.circunstancias'
        db.alter_column(u'archivo_caso', 'circunstancias', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Caso.circunstancias'
        db.alter_column(u'archivo_caso', 'circunstancias', self.gf('django.db.models.fields.TextField')(default=''))
