...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipoEdad'
        db.create_table(u'archivo_tipoedad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'archivo', ['TipoEdad'])

        # Adding field 'Caso.tipo_edad'
        db.add_column(u'archivo_caso', 'tipo_edad',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['archivo.TipoEdad'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TipoEdad'
        db.delete_table(u'archivo_tipoedad')

        # Deleting field 'Caso.tipo_edad'
        db.delete_column(u'archivo_caso', 'tipo_edad_id')
    ...
    models = {
        ...
        u'archivo.caso': {
            ...
            'tipo_edad': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['archivo.TipoEdad']", 'null': 'True'})
        },
