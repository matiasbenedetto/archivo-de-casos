...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caso.situacion_procesal'
        db.alter_column(u'archivo_caso', 'situacion_procesal', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Caso.situacion_procesal'
        db.alter_column(u'archivo_caso', 'situacion_procesal', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'archivo.caso': {
            ...
            'circunstancias': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'imagen': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'situacion_procesal': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'tipo_edad': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['archivo.TipoEdad']", 'null': 'True', 'blank': 'True'})
        },
