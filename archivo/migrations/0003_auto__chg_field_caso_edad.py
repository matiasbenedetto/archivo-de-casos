...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('archivo_caso', 'edad', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Caso.edad'
        db.alter_column('archivo_caso', 'edad', self.gf('django.db.models.fields.IntegerField')())
