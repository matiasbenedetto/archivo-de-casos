...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caso.anio'
        db.alter_column('archivo_caso', 'anio', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Caso.anio'
        db.alter_column('archivo_caso', 'anio', self.gf('django.db.models.fields.IntegerField')(default=None))
